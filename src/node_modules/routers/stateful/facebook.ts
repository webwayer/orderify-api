...
export function facebookLoginRouterFactory(router: Router, CONFIG: FACEBOOK_CONFIG & API_CONFIG, User: UserType, Album: AlbumType, Photo: PhotoType, storage: storage.Client) {
    const redirect_uri = `${CONFIG.PROTOCOL}://${CONFIG.HOST}:${CONFIG.PORT}/login/facebook/callback`
