...
export function fromFacebookFactory(request: RequestPromiseAPI, storage: storage.Client, Album: AlbumType, Photo: PhotoType, facebookGraph: ReturnType<typeof facebookGraphFactory>) {
    async function upload(userId: number, access_token: string) {
